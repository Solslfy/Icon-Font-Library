...
| Name | Preview | Path |
|------|---------|------|
| `archive` | <img src="archive.svg" width="28" height="28" alt="archive"> | `icons/outline/files/archive.svg` |
| `book` | <img src="book.svg" width="28" height="28" alt="book"> | `icons/outline/files/book.svg` |
| `book-open` | <img src="book-open.svg" width="28" height="28" alt="book-open"> | `icons/outline/files/book-open.svg` |
| `clipboard` | <img src="clipboard.svg" width="28" height="28" alt="clipboard"> | `icons/outline/files/clipboard.svg` |
| `clipboard-check` | <img src="clipboard-check.svg" width="28" height="28" alt="clipboard-check"> | `icons/outline/files/clipboard-check.svg` |
| `clipboard-list` | <img src="clipboard-list.svg" width="28" height="28" alt="clipboard-list"> | `icons/outline/files/clipboard-list.svg` |
| `download-cloud` | <img src="download-cloud.svg" width="28" height="28" alt="download-cloud"> | `icons/outline/files/download-cloud.svg` |
...
| `folder` | <img src="folder.svg" width="28" height="28" alt="folder"> | `icons/outline/files/folder.svg` |
...
| `save` | <img src="save.svg" width="28" height="28" alt="save"> | `icons/outline/files/save.svg` |
| `scroll` | <img src="scroll.svg" width="28" height="28" alt="scroll"> | `icons/outline/files/scroll.svg` |
| `sticky-note` | <img src="sticky-note.svg" width="28" height="28" alt="sticky-note"> | `icons/outline/files/sticky-note.svg` |
| `upload-cloud` | <img src="upload-cloud.svg" width="28" height="28" alt="upload-cloud"> | `icons/outline/files/upload-cloud.svg` |
